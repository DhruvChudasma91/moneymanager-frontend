    ...
    <Dashboard activeMenu="Filters">
      <div className="my-5 mx-auto">
        ...
        <div className="card p-4 mb-4">
          ...
          <form className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-7 gap-3">
            <div>
            ...
            <div>
              ...
              <input value={startDate} id="startdate" type="date" className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-purple-500 focus:outline-none"
               onChange={e => setStartDate(e.target.value) }/>
            </div>

            <div>
              <label htmlFor="enddate" className="block text-sm font-medium mb-1">End Date</label>
              <input value={endDate} id="enddate" type="date" className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-purple-500 focus:outline-none" onChange={e => setEndDate(e.target.value)}/>
            </div>
            ...
            <div className="sm:col-span-1 md:col-span-2 flex items-end">
              ...
              <button 
                ...
                className="ml-2 mb-1 p-2 bg-purple-700 hover:bg-purple-500 transition-all duration-200 text-white rounded-lg flex items-center justify-center shadow-md disabled:opacity-50"
              >
                <Search size={20}/>
              </button>
            </div>
