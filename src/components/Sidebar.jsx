...
import { User, LayoutDashboard, List, Wallet, Coins, FunnelPlus } from "lucide-react";
...
const Sidebar = ({activeMenu}) => {
    ...
    return (
        <div className="w-60 h-[calc(100vh-64px)] bg-white border-gray-200 sticky top-[61px] p-5 z-20">
